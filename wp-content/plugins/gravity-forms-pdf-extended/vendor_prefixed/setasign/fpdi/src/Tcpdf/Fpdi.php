                ...
                switch ($key) {
                    case 'BS':
                        ...
                        if (isset($value->value['W'])) {
                            $bs['w'] = \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfNumeric::ensure(\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::resolve($value->value['W'], $parser))->value;
                        }
                        if (isset($value->value['S'])) {
                            $bs['s'] = \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfName::ensure(\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::resolve($value->value['S'], $parser))->value;
                        }
                        if (isset($value->value['D'])) {
                            $d = [];
                            foreach (\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfArray::ensure(\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::resolve($value->value['D'], $parser))->value as $item) {
                                $d[] = \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfNumeric::ensure(\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::resolve($item, $parser))->value;
                            }
                            $bs['d'] = $d;
                        }
                        ...
                        break;
                    case 'Border':
                        $borderArray = \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfArray::ensure(\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::resolve($value, $parser))->value;
                        if (\count($borderArray) < 3) {
                            continue 2;
                        }
                        $border = [\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfNumeric::ensure(\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::resolve($borderArray[0], $parser))->value, \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfNumeric::ensure(\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::resolve($borderArray[1], $parser))->value, \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfNumeric::ensure(\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::resolve($borderArray[2], $parser))->value];
                        if (isset($borderArray[3])) {
                            $dashArray = [];
                            foreach (\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfArray::ensure(\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::resolve($borderArray[3], $parser))->value as $item) {
                                $dashArray[] = \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfNumeric::ensure(\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::resolve($item, $parser))->value;
                            }
                            $border[] = $dashArray;
                        }
                    ...
                    case 'C':
                        ...
                        foreach ($colors as $item) {
                            $c[] = \GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfNumeric::ensure(\GFPDF_Vendor\setasign\Fpdi\PdfParser\Type\PdfType::resolve($item, $parser))->value * $m;
                        }
